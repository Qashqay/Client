...
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 3. ??? 12:41:04 2015
# Project:  Lab2_client.pro
# Template: app
# Command: c:\Qt\4.8.4.1\bin\qmake.exe -spec c:\Qt\4.8.4.1\mkspecs\win32-g++ CONFIG+=release -o Makefile Lab2_client.pro
#############################################################################
...
Makefile: Lab2_client.pro  c:/Qt/4.8.4.1/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4.1/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.4.1\mkspecs\win32-g++ CONFIG+=release -o Makefile Lab2_client.pro
